...
@include('sweetalert::alert')
    <div class="py-3 px-8 w-full">
        <div class="flex justify-between mt-4 ml-3">
            <h1 class="font-bold text-3xl">Drivers</h1>
            <a href="{{route('admin.drivers.create')}}" class="bg-indigo-700 text-white px-6 mr-5 rounded-md mb-2 py-1">Add</a>
        </div>
            ...
            <tbody>
                ...
                <tr class="border border-gray-400 ">
                    ...
                    {{-- <td class="border px-4 border-gray-200 w-52">
                        <img src="/storage/{{$driver->photopath}}">
                    </td> --}}
                    
                    <td class="py-2 h-full items-center px-2 flex">
                        <a href="{{route('admin.drivers.edit',$driver->id)}}"><i class="text-xl px-2  fas fa-edit text-white hover:text-black bg-green-600 pt-2 pb-2" > Edit</i>  </a>
                        <a href="{{route('admin.drivers.show',$driver->id)}}"><i class="text-xl px-2 mx-2  fas fa-eye text-white hover:text-black bg-violet-600 pt-2 pb-2" > Show</i>  </a>
    
                        <a > <i class="text-xl px-2 fas fa-trash-alt text-white hover:text-black bg-red-600 pt-2 pb-2" onclick="showdelete({{$driver->id}})"> Delete</i>  </a>
                    </td>
                        ...
                        <div id="deletemodal"  class="white-card hidden dark:bg-white dark:bg-opacity-10 overflow-y-auto overflow-x-hidden fixed right-0 left-0 top-20 z-50 justify-center items-center md:h-full md:inset-0  align-middle"  >
                            <div class="relative px-4 w-full max-w-md h-full md:h-auto mx-auto ">
                                ...
                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700 pb-8">
                                    ...
                                    <form class="px-6 pb-4 space-y-6 lg:px-8 sm:pb-6 xl:pb-8" method="POST" action="{{route('admin.drivers.delete')}}">
                                    @csrf
