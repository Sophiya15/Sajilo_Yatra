...
@section('main')
    ...
    <div class="py-3 px-8 w-full">
        <div class="flex justify-between py-2">
          ...
          <form action="{{route('admin.vehicles.update',$vehicle->id)}}" method="post" enctype="multipart/form-data" class="py-5">
            @csrf
            @method('put')
                <div class="my-2">
                    <label class="text-gray-500">Enter Vehicle Name</label>
                    <input type="text" name="name" id="" class="w-full border-none shadow-lg rounded-md placeholder:text-gray-700 focus:ring-amber-500" placeholder="Enter Vehicle Name" value="{{$vehicle->name}}">
                    @error('name')
                ...
                <div class="my-2 mt-5">
                    ...
                    <input type="text" name="model" id="" class="w-full border-none shadow-lg rounded-md placeholder:text-gray-700 focus:ring-amber-500" placeholder="Enter vehicle model" value="{{$vehicle->model}}">
                    @error('model')
                        <p class="text-red-500 p-2">
                            {{$message}}
                        </p>
                ...
                <div class="my-2 mt-5">
                    ...
                    <input type="text" name="seater" id="" class="w-full border-none shadow-lg rounded-md placeholder:text-gray-700 focus:ring-amber-500" placeholder="Enter number of seat" value="{{$vehicle->seater}}">
                    @error('seater')
                        <p class="text-red-500 p-2">
                            {{$message}}
                        </p>
                ...
                <div class="my-2 mt-5">
                    ...
                    <input type="text" name="price" id="" class="w-full border-none shadow-lg rounded-md placeholder:text-gray-700 focus:ring-amber-500" placeholder="Enter the Rental Price" value="{{$vehicle->price}}">
                    @error('price')
                        <p class="text-red-500 p-2">
                            {{$message}}
                        </p>
                ...
                <div class="my-2 mt-5">
                    ...
                    <input type="text" name="plate" id="" class="w-full border-none shadow-lg rounded-md placeholder:text-gray-700 focus:ring-amber-500" placeholder="Enter the number of plate of car" value="{{$vehicle->plate}}">
                    @error('plate')
                        <p class="text-red-500 p-2">
                            {{$message}}
                        </p>
                ...
                <div class="my-2 mt-5">
                    ...
                    <select  name="fuelType" id="" class="w-full border-none shadow-lg rounded-md placeholder:text-gray-700 focus:ring-amber-500">
                        ...
                        <option value="Petrol" @if($vehicle->fuelType == "Petrol") selected @endif>Petrol</option>
                    </select>
                    @error('fuelType')
                        <p class="text-red-500 p-2">
                            {{$message}}
                ...
                <div class="my-2 mt-5">
                    ...
                    <select  name="isAvailable" id="" class="w-full border-none shadow-lg rounded-md placeholder:text-gray-700 focus:ring-amber-500">
                        ...
                        <option value="1" @if($vehicle->isAvailable == 1) selected @endif>Yes</option>
                        <option value="0" @if($vehicle->isAvailable == 0) selected @endif>No</option>
                    </select>
                    @error('isAvailable')
                        <p class="text-red-500 p-2">
                            {{$message}}
                ...
                <div class="my-2 mt-5">
                    ...
                    <textarea name="extra" id="basic-example" class="w-full border-none shadow-lg rounded-md placeholder:text-gray-700 focus:ring-amber-500" placeholder="Enter Extra Features">{{$vehicle->extra}}</textarea>
                    @error('extra')
                        <p class="text-red-500 p-2">
                            {{$message}}
                        </p>
