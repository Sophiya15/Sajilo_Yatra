...
<div class="grid grid-cols-2 ">
    ...
    <div class="pt-20 bg-white rounded-lg shadow-lg" >
    ...
    <div class="shadow-lg rounded-lg bg-white">
        ...
        <div class="grid grid-cols-4  py-[3%]">
            ...
            <div class="shadow-lg rounder-lg border-2 border-white pt-5 m-3 bg-yellow-500">
            ...
            <div class="rounded-lg shadow-lg border-2 border-white pt-5 m-3 bg-yellow-500">
