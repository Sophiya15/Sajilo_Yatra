...
<h1 class="px-[20%] pb-5 pt-[5%] font-bold text-3xl bg-slate-300"> Do you have any questions? Please do not hesitate to contact us directly. Our team will come back to you within a matter of hours to help you. </h1>
<div class="grid grid-cols-2 px-[5%] font-bold text-3xl bg-slate-300">
